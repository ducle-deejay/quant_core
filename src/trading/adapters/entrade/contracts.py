...
from trading.instruments import build_futures_contract
...
def resolve_active_contract(
    ...
    *,
    ...
    if not isinstance(records, list):
        raise ValueError("Entrade derivatives response does not contain a data list")
    ...
    active = [contract for contract in contracts if contract.trading_cutoff >= at.astimezone(UTC)]
    if not active:
