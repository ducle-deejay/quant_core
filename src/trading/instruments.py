...
class FuturesInstrumentSpec:
    """NOX-owned data contract for constructing a Nautilus futures instrument."""
...
def load_futures_instrument_spec(path: str | Path) -> FuturesInstrumentSpec:
    """Load the NOX futures instrument contract from JSON."""
...
def build_continuous_futures_contract(
    ...
    """Compose the continuous signal instrument used by NOX."""
