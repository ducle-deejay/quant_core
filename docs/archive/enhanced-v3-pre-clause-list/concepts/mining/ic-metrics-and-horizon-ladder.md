...
2.5 Shape reading. IC rising with horizon (0.022 to 0.055 to 0.085) means a persistent, cost-survivable signal. IC spiking at h=1 then dying means ultra-short edge that costs will murder. Both shapes appear in [[case-studies/seed-alpha-demo.md]].
