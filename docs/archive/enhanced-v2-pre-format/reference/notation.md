...
Former bare lambda was ambiguous between the EWMA weight and the turnover
penalty; split into lambda_s and lambda_w. Former bare k as a pool-size counter
is renamed n_alpha; k stays reserved as a local, declared-at-use-site name (for
example seed grammar window lengths).
