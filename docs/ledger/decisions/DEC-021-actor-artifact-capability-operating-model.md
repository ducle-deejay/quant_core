---
doc_id: DEC-021
title: Systematic trading operating model - actor, artifact, and capability boundaries
type: decision
owner: research
status: resolved
version: 1.0
components: [0, 1, 2, 3, 4, 5, 6, 7]
tags: [operating-model, lifecycle, research-roles, capability-ownership]
source: "owner approval 2026-09-03: actor-, artifact-, and capability-level correction following OBS-018 review of DEC-019 and DEC-020"
...
# DEC-021 - Systematic Trading Operating Model

## 1. Decision and Scope

This decision supersedes DEC-020 as the self-contained operating model and implementation-planning guide. It preserves the valid Rust and Nautilus ownership corrections from DEC-020 while correcting the contract leakage recorded by OBS-018. The substantive content of DEC-019 and DEC-020 remains unchanged as the historical record of the brainstorming and runtime-ownership corrections that led to this decision.
...
PORTFOLIO RESEARCH AND REFIT
    ...
    Portfolio Researcher defines and versions:
        composition policy
...
Do not invent replacement methods for researcher-owned activities. In particular, the absence of an alpha-hypothesis-generation method does not authorize a submission, registration, or creation API without a separate use case and contract discussion.

## 12. Status and Acceptance

The owner approved the complete actor, artifact, capability, lifecycle, and activation-governance wording on 2026-09-03. This decision is `resolved`, supersedes DEC-020 as the implementation-planning guide, and resolves OBS-018. Implementation planning may now audit current code against this operating model without treating its capability labels as approved API methods.
...
- [DEC-020](DEC-020-systematic-trading-operating-model-correction.md) - runtime-ownership correction preserved as the immediate predecessor.
