...
```text
    ...
    vol_est_HF  high-frequency volatility estimate
                ([notation](../../reference/notation.md))
    m_*         overlay multipliers, each owned by a separate
                subsystem (sections 2.3-2.7 below)
```
...
- Related: [vol-targeting](vol-targeting.md), [drawdown-overlay](../combination/drawdown-overlay.md), [meta-labeling](../combination/meta-labeling.md), [position-sizing-methods](position-sizing-methods.md)
