...
Survivor organization continues in [stage-0-alpha-mining](../../stages/stage-0-alpha-mining.md), section 7.

---
## Related notes
- Up: [stage-0-alpha-mining](../../stages/stage-0-alpha-mining.md)
- Related: [formulaic-alpha-and-seeds](formulaic-alpha-and-seeds.md), [trial-count-and-thresholds](../evaluation/trial-count-and-thresholds.md)
