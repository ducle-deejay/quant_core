...
4.1 Current position: family one, method two - formulaic expressions mined by search (GA over the DSL grammar), evaluated through the canonical harness. See [seed-alpha-demo](../../case-studies/seed-alpha-demo.md) for the working loop.
...
---
## Related notes
- [stage-0-alpha-mining](../../stages/stage-0-alpha-mining.md) - the mining component this note extends
- [ic-metrics-and-horizon-ladder](ic-metrics-and-horizon-ladder.md) - forecast quality measurement shared by both families
- [ga-machinery](ga-machinery.md) - current search engine
- [seed-alpha-demo](../../case-studies/seed-alpha-demo.md) - working example of family one
