...
- [stage-0-alpha-mining](stages/stage-0-alpha-mining.md) through [stage-7-risk-overlay-monitoring](stages/stage-7-risk-overlay-monitoring.md)
- the eight component specifications
- [trial-count-and-thresholds](concepts/evaluation/trial-count-and-thresholds.md) - trial ledger behind the dynamic thresholds referenced above
- [spec-sheet-and-monitoring](concepts/evaluation/spec-sheet-and-monitoring.md) - expectations consumed by divergence monitoring
- [divergence-monitoring](concepts/risk/divergence-monitoring.md) - gauges and escalation ladder
- [post-mortem](concepts/evaluation/post-mortem.md) - failure dissection feeding edge 2 -> 0
